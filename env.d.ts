/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 78873b39cee0452e1a2520e0233a31d3)
// Runtime types generated with workerd@1.20260921.1 2026-09-23 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	BriefingAgent: DurableObjectNamespace<import("./src/server").BriefingAgent>;
	BRIEFING_WORKFLOW: Workflow<Parameters<import("./src/server").BriefingWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "BriefingAgent";
	}
